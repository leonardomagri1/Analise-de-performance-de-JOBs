        ...
        if area_logs_aberta:
            ...
            if dados_copiados:
                ...
                if caminho_arquivo_salvo:
                    ...
                    df_dados = visualizacao_test.processar_dados_log(caminho_arquivo_salvo)
                    if df_dados is not None:
                        visualizacao_test.gerar_grafico_desempenho(df_dados, NOME_DO_JOB)